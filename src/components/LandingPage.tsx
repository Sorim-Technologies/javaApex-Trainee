    ...
    <div style={styles.container}>
      ...
      <div style={styles.hero}>
        ...
        <p style={styles.description}>
          Accelerate your Java application migration with automated tools and
          intelligent refactoring. Upgrade to newer Java versions with minimal
          effort and maximum reliability. Reduce technical debt and improve
          performance across your entire codebase.
        </p>
        ...
        <div style={styles.features}>
          ...
          >
            ...
            <div style={styles.featureDesc}>
              Automated refactoring and code transformation in minutes
            </div>
          </div>
          ...
          >
            ...
            <div style={styles.featureDesc}>
              Comprehensive dependency and compatibility scanning
            </div>
          </div>
          ...
          >
            ...
            <div style={styles.featureDesc}>
              Automated testing and SonarQube integration included
            </div>
          </div>
        </div>
