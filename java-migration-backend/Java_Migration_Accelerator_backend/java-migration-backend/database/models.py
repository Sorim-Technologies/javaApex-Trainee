...
class MigrationHistory(Base):
    ...
    migration_report_email_status = Column(String(50), nullable=True)
    migration_report_email_to = Column(String(255), nullable=True)
    migration_report_email_sent_at = Column(DateTime, nullable=True)
    migration_report_email_error = Column(Text, nullable=True)
