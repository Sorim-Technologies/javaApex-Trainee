...
CREATE TABLE IF NOT EXISTS migration_history (
  ...
  migration_report_email_status VARCHAR(50) NULL,
  migration_report_email_to VARCHAR(255) NULL,
  migration_report_email_sent_at DATETIME NULL,
  migration_report_email_error TEXT NULL,
