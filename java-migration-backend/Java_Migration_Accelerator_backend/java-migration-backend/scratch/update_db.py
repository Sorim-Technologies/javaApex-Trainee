...
job_id = "a179f3fe-8bc1-4879-8f6e-456c5ab48134"
...
try:
    ...
    if migration:
        ...
        print(f"Before - total: {migration.tests_total}, passed: {migration.tests_passed}, failed: {migration.tests_failed}, line: {migration.coverage_line}")
        ...
        print(f"After - total: {migration.tests_total}, passed: {migration.tests_passed}, failed: {migration.tests_failed}, line: {migration.coverage_line}")
    else:
